...
También considero relevantes las actividades de clase centradas en investigación visual, evaluación y prototipado. En la actividad de moodboard trabajé la traducción de un concepto de marca a referencias visuales, tipografías, paleta, emociones y usuarios, una práctica que luego apliqué al moodboard de PogoRamen. En la actividad 4 de usabilidad y Heurio pude realizar una revisión heurística colaborativa, identificando problemas sobre una interfaz real y formulando comentarios accionables en lugar de opiniones generales: https://heurio.app/project/UEwybjBxdGVRMXBYZWNRZ3pmQXJrUT09. En la actividad 5 de accesibilidad evaluamos una web institucional con criterios WCAG/POUR, WAVE y simuladores como Funkify; en mi caso, sobre la web del Ayuntamiento de Guadix detectamos falta de información de accesibilidad, problemas de contraste, alertas de comprensión y barreras para baja visión. La actividad 6 me permitió practicar microinteracciones y estilo UI con un portfolio neobrutalista creado en Figma Make y publicado como web navegable en https://santa-waffle-55473951.figma.site. Finalmente, el ejercicio Shop6/UrbanPulse reforzó la parte de identidad visual: estrategia de marca, logotipo, paleta, tipografía y tono visual urbano. Estas actividades complementan PogoRamen porque cubren el ciclo completo: inspiración, evaluación, accesibilidad, prototipado y comunicación visual.
...
- Ejercicios de clase revisados en carpeta local: moodboard, usabilidad, accesibilidad, microinteracción y Shop6/UrbanPulse.
